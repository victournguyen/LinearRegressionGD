...
This project is optimized for uploading to Amazon Web Services, specifically for an Elastic Beanstalk Web Server application and environment. It is accessible <a href="https://bit.ly/linreggd" target="_blank" rel="noopener">here</a> (the environment may or may not be activated).
